...
browser.find_element(By.CSS_SELECTOR, ".loca_step1_cont .sido_arae_box li:nth-child(14)").click()
time.sleep(3) 
print("충남 버튼을 클릭했습니다.")
...
final_data = {
    ...
    "date": current_date,
    "location": "충남(chungnam)",
    "count": len(store_data_list),
    "item": store_data_list
}

# JSON 파일 저장
output_file_path = os.path.join(base_folder_path, f"chungnam_{current_date}.json")
