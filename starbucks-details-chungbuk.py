...
base_folder_path = os.path.join("details", current_year, "chungbuk")
...
final_data = {
    ...
    "date": current_date,
    "location": "충북(chungbuk)",
    "count": len(store_data_list),
    "item": store_data_list
}

# JSON 파일 저장
output_file_path = os.path.join(base_folder_path, f"chungbuk_{current_date}.json")
