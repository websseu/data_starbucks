...
base_folder_path = os.path.join("details", current_year, "sejong")
...
browser.find_element(By.CSS_SELECTOR, ".loca_step1_cont .sido_arae_box li:nth-child(17)").click()
time.sleep(3) 
print("세종 버튼을 클릭했습니다.")

# 세종은 전체선택 버튼이 없으므로 바로 점포 리스트 가져오기
time.sleep(3)
...
# JSON 파일 저장
output_file_path = os.path.join(base_folder_path, f"sejong_{current_date}.json")
