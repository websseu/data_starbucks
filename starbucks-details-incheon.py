...
base_folder_path = os.path.join("details", current_year, "incheon")
...
browser.find_element(By.CSS_SELECTOR, ".loca_step1_cont .sido_arae_box li:nth-child(8)").click()
time.sleep(3) 
print("인천 버튼을 클릭했습니다.")
...
# JSON 파일 저장
output_file_path = os.path.join(base_folder_path, f"incheon_{current_date}.json")
