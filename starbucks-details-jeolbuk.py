...
base_folder_path = os.path.join("details", current_year, "jeolbuk")
...
browser.find_element(By.CSS_SELECTOR, ".loca_step1_cont .sido_arae_box li:nth-child(13)").click()
time.sleep(3) 
print("전북 버튼을 클릭했습니다.")
...
# JSON 파일 저장
output_file_path = os.path.join(base_folder_path, f"jeolbuk_{current_date}.json")
